...
abstract class PuzzleColors {
  ...
  static const Color darkGray = Color(0xFF646464);

  static const Color greenLight = Color(0xFF10FB09);
  static const Color greenDark = Color(0xFF198116);

  static const Color backgroundDark = Color(0xFF272048);
  static const Color backgroundLight = Color(0xFF322958);
