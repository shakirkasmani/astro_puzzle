...
/// The animation builder of [AstroSuccessDialog].
class AstroSuccessDialogAnimatedBuilder extends StatelessWidget {
  const AstroSuccessDialogAnimatedBuilder({
    Key? key,
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return builder(
          context,
          child,
          AstroShareDialogEnterAnimation(animation as AnimationController),
        );
      },
      child: child,
    );
...
typedef MyTransitionBuilder = Widget Function(
  ...
  Widget? child,
  AstroShareDialogEnterAnimation animation,
);

class AstroShareDialogEnterAnimation {
  AstroShareDialogEnterAnimation(this.controller)
